...
// func (s *service) CreateOrUpdate(ctx context.Context, local *azurev1alpha1.VM, remote compute.VirtualMachine) (done bool, err error) {
...
// 			return false, err
// 		}
// 		future = compute.VirtualMachinesCreateOrUpdateFuture{
// 			Future: azureFuture,
// 		}
// 	} else {
...
// func (s *service) Get(ctx context.Context, local *azurev1alpha1.VM) (result compute.VirtualMachine, err error) {
// 	client, err := clients.NewVirtualNetworksClient(local.Spec.SubscriptionID, s.factory)
// 	if err != nil {
...
// func (s *service) Delete(ctx context.Context, local *azurev1alpha1.VM, log logr.Logger) (bool, error) {
// 	client, err := clients.NewVirtualNetworksClient(local.Spec.SubscriptionID, s.factory)
// 	if err != nil {
// 		return false, err
// 	}
...
// 			return false, err
// 		}
// 		future = compute.VirtualMachinesDeleteFuture{
// 			Future: azureFuture,
// 		}
// 	} else {
// 		log.Info("no existing future found, beginning deletion")
