...
func (c *Client) Get(ctx context.Context, obj runtime.Object) (network.VirtualNetwork, error) {
	local, err := c.convert(obj)
	if err != nil {
...
func (c *Client) convert(obj runtime.Object) (*azurev1alpha1.VirtualNetwork, error) {
