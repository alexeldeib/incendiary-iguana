...
type ServiceBusKeyReconciler struct {
	Service    *services.ServiceBusService
	Kubeclient ctrl.Client
	Scheme     *runtime.Scheme
}

// Ensure creates or updates a redis cache in an idempotent manner.
func (r *ServiceBusKeyReconciler) Ensure(ctx context.Context, obj runtime.Object, log logr.Logger) (bool, error) {
...
func (r *ServiceBusKeyReconciler) SyncSecrets(ctx context.Context, local *azurev1alpha1.ServiceBusNamespace) error {
...
func (r *ServiceBusKeyReconciler) Delete(ctx context.Context, obj runtime.Object, log logr.Logger) (bool, error) {
	local, err := r.convert(obj)
	if err != nil {
		return false, err
	}
