...
func downloadAndFormat(ctx context.Context, service *SecretService, item azurev1alpha1.SecretIdentifier) ([]byte, error) {
	if item.Kind == nil {
...
func download(ctx context.Context, service *SecretService, vault, name string) (string, error) {
...
func downloadCertificateSHA(ctx context.Context, service *SecretService, vault, name string) (string, error) {
