...
go_library(
    ...
    deps = [
        ...
        "//pkg/services/keyvaults:go_default_library",
        "//pkg/services/resourcegroups:go_default_library",
        "//pkg/services/secrets:go_default_library",
        "//pkg/services/securitygroups:go_default_library",
        "//pkg/services/subnets:go_default_library",
        "//pkg/services/virtualnetworks:go_default_library",
