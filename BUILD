...
go_library(
    ...
    deps = [
        ...
        "//pkg/clients/secrets:go_default_library",
        "//pkg/clients/securitygroups:go_default_library",
        "//pkg/clients/subnets:go_default_library",
        "//pkg/clients/virtualnetworks:go_default_library",
